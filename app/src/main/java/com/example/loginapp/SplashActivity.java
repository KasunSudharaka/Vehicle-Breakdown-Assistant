            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot != null) {
                    ...
                    try {
                        ...
                        if (veh != null) {
                            Intent gotoVOMap = new Intent(SplashActivity.this, VOMapActivity.class);
                            finish();
                            startActivity(gotoVOMap);
                        }
                    } catch (NullPointerException n) {

                        Intent gotoSSMap = new Intent(SplashActivity.this, SStMapActivity.class);
                        finish();
                    ...
                    Toast.makeText(SplashActivity.this, "Couldn't identify login type", Toast.LENGTH_LONG).show();
                }
            }
