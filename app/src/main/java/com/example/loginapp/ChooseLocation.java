...
public class ChooseLocation extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(ChooseLocation.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},LOCATION_REQ_CODE );
        }
        else {
        ...
        mfusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(ChooseLocation.this,"task failed",Toast.LENGTH_LONG).show();}
            }
        });
    ...
    private void geoLocate(){
        ...
        Geocoder geocoder=new Geocoder(ChooseLocation.this);
                ...
                geoss.setLocation(uidss, new GeoLocation(temp.latitude, temp.longitude), new GeoFire.CompletionListener() {
                    ...
                    public void onComplete(String key, DatabaseError error) {
                        ...
                        if (error != null) {
                            ...
                            Toast.makeText(ChooseLocation.this,"Saving the location",Toast.LENGTH_LONG).show();
                            System.out.println("Location saved on server successfully!");

                            Toast.makeText(ChooseLocation.this,"Please verify your email to continue",Toast.LENGTH_LONG).show();

                            Intent gotoSignin=new Intent(ChooseLocation.this,LoginActivity.class);
